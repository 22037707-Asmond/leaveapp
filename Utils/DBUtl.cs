...
public static class DBUtl
{
    ...
    private static readonly string DB_CONNECTION = config.GetValue<String>("DefaultConnection1") ?? "";
    ...
    public static int ExecSQL(string sql, params object?[] list)
    {
        ...
        {
            DB_Message = "Data modification only permitted in development database";
            return 0;
        }
